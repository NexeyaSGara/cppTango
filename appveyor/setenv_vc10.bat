...
set PATH=%SystemRoot%\system32;"C:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\bin";"C:\Program Files (x86)\microsoft visual studio 10.0\common7\ide";
...
set PATH=%SystemRoot%\system32;"C:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\bin\x86_amd64";"C:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\bin";"C:\Program Files (x86)\Microsoft Visual Studio 10.0\Common7\ide";
